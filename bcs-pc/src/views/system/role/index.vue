  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <div class="top-right-btn">
        <el-col :span="1.5">
          <el-button type="primary" @click="handleAdd" v-hasPermi="['system:role:add']">添加
          </el-button>
        </el-col>
      </div>
...
<!--        v-if="scope.row.roleId !== 1"-->
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body center
      ...
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="菜单权限">
          <el-tree class="tree-border" :data="menuOptions" show-checkbox ref="menu" node-key="id" empty-text="加载中，请稍候"
            :check-strictly="true" :props="defaultProps"></el-tree>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button type="info" @click="cancelDataScope">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要' + text + '角色吗？', text).then(function () {
    ...
    submitDataScope: function () {
      if (this.form.roleId != undefined) {
        ...
        changeMenu(this.form).then(response => {
          this.$modal.msgSuccess(response.msg);
          this.openDataScope = this.btnLoading = false;
          this.getList();
        });
      }
    },
