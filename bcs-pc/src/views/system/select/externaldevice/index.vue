<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch" label-width="90px">
      <el-form-item label="外接设备名称" prop="name">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-plus"
          @click="handleAdd"
          v-hasPermi="['system:externalDevice:edit']"
        >添加</el-button>
      </el-col>
    </el-row>
...
<!--      <el-table-column type="selection" width="55" align="center" />-->
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['system:externalDevice:status']"
          >禁用</el-button>
          <el-button
            v-else
            type="text"
            @click="setStatus(scope.row, 0)"
            v-hexternalDeviceasPermi="['system:externalDevice:status']"
          >启用</el-button>
          <el-button
            type="text"
            @click="handleDelete(scope.row)"
            v-hasPermi="['system:externalDevice:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="外接设备名称:" prop="name">
          <el-input v-model="form.name" placeholder="请输入外接设备名称" />
        </el-form-item>
